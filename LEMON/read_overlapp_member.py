...
def generate_overlapp_vertex_file():
    ...
    print "Total Vertex hasil union UNIK ini yang ditampilkan :", len(temp)
    print "total Vertex dari semuanya BISA DOBEL : ", total_vertex    
...
#    nx.draw_networkx(G_lemons, node_color = color_map, labels = labels, node_size = size_map, with_labels = True, width = 0.1, alpha = 0.4,font_size=8) 
#    
#    plt.show()
